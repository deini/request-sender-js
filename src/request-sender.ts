...
export default class RequestSender {
    ...
    private _shouldCacheRequest(options: RequestOptions) {
    ...
    private _getCachedRequest<T>(url: string, options: RequestOptions) {
    ...
    private _cacheRequest<T>(url: string, options: RequestOptions, response: Response<T>) {
        if (this._shouldCacheRequest(options)) {
